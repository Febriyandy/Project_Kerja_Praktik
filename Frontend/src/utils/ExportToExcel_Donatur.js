...
export const exportToExcel = (data, { tahunPelajaran }) => {
    ...
    const header = ["NO", "TANGGAL", "KETERANGAN", "DEBIT", "KREDIT", "SALDO"];
    ...
    excelRows.push([`Laporan Arus Kas Majelis Dikdasmen dan PNF Muhammadiyah Tanjungpinang`]);
    ...
    // Export file Excel
    XLSX.writeFile(workbook, `Laporan_Arus_Kas_Yayasan_${tahunPelajaran}.xlsx`);
};
