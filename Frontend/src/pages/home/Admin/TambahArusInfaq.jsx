...
const TambahArusInfaq = ({ onTambahComplate, currentSaldo }) => { // Mengambil currentSaldo sebagai properti
  ...
  const saveData = async (e) => {
    ...
    try {
      ...
      formData.append("id_infaqYayasan", id);
      ...
      await axiosJWT.post(`${import.meta.env.VITE_API_URL}/TambahArusInfaq/${id}`, formData, {
        headers: {
...
export default TambahArusInfaq;
