...
const TambahArusKas = ({ onTambahComplate, currentSaldo }) => { // Mengambil currentSaldo sebagai properti
  ...
  const saveData = async (e) => {
    ...
    try {
      ...
      formData.append("id_kasSekolah", id);
      formData.append("kode_nota", kode_nota);
      ...
      await axiosJWT.post(`${import.meta.env.VITE_API_URL}/TambahArusKas/${id}`, formData, {
        headers: {
        ...
        <div className="w-1/2 -mt-7 h-auto mx-12 rounded-lg shadow-md">
          ...
          <form onSubmit={saveData} className="px-5 py-3 font-body text-sm">
            ...
            >
              ...
              <option value="Saldo Akhir Tahun">Saldo Akhir Tahun</option>
            </select>
