...
import TambahArusInfaq from "./TambahArusInfaq";
...
const DetailInfaq = () => {
  ...
  const handleTambahDataClick = () => {
    setTambahDataArusInfaq(true);
  };

  const handleTambahDataComplete = () => {
    setTambahDataArusInfaq(null);
    getDataArusInfaq();
  };
  ...
  const deleteArusInfaq = async (id) => {
    try {
      ...
      if (result.isConfirmed) {
        await axiosJWT.delete(`${import.meta.env.VITE_API_URL}/HapusArusInfaq/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
      ...
      console.error("Error deleting Arus Infaq:", error);
          ...
          <section className="w-11/12 mx-auto h-full mt-16">
            <div className="flex items-center justify-between gap-6">
              <div className="flex items-center">
                <Link to="/admin/infaq" className="text-2xl">
