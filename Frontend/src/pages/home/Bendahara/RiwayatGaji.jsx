...
const RiwayatGajiGuru = () => {
  ...
  const getDataGuru = async () => {
    try {
      const response = await axiosJWT.get(
        `${import.meta.env.VITE_API_URL}/DataGajiGuru/${npsn}`,
        {
          headers: {
  ...
  const filteredData = data_guru.filter(
    (guru) =>
      (selectedTahunPelajaran
        ? guru.tahun_pelajaran === selectedTahunPelajaran
        : true)
  );
        ...
        <div className="flex justify-between">
          <div className="flex gap-4">
              ...
              <p className="font-body text-base font-bold text-secondary">
                Riwayat Pembayaran Gaji Guru {nama_sekolah}
              </p>
            </div>
          ...
          <div className=" mx-auto mt-5 mb-10 px-5 h-full border border-gray-300 shadow-md rounded-lg overflow-y-auto">
...
export default RiwayatGajiGuru;
